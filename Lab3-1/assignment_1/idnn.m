...
wss = [10 20 30 40 50];                  % window size
etas = [0.1 0.01 0.001 0.0001];     % learning rate
alphas = [0.1 0.5 0.9];         % momentum
lambdas = [0 1e-3 1e-4];        % regularization

%trfuns = {'traingdx', 'traingdm', 'trainrp'};
max_epochs = 1000;
trfun = 'trainrp';
...
% saving results
save('idnn_lab31_results.mat','idnn_net', 'tr_record', 'error_tr_final', 'error_ts_final')
